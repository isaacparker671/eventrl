...
alter table public.event_scanner_roles enable row level security;
alter table public.event_scanner_identities enable row level security;
...
alter table public.event_question_requests enable row level security;
